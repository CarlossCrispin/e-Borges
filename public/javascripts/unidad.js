...
var app = angular.module('unidadApp', []);
app.controller('unidadController', function ($scope, $http) {
    ...
    $scope.update= function () {
        ...
        $scope.clicked={
            id:$scope.clicked.idunidad,
            nombre: $scope.clicked.nombre ,
            lugar : $scope.clicked.lugar || '',
