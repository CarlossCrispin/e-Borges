var app = angular.module('especialidadApp', []);
app.controller('especialidadController', function ($scope, $http) {
    ...
    $scope.save = function () {
        $scope.new = {
            especialidad :$scope.new.especialidad  || '',
        };
    ...
    $scope.update= function () {
        ...
        $scope.clicked={
            id:$scope.clicked.idespecialidad,
            especialidad :$scope.clicked.especialidad  || '',
