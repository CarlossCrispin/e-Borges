...
(function($) {
  ...
  function InputsSearch(obj, settings) {
    ...
    this.create = function() {
      var $search = $('<input class="classy "type="text" name="search"  placeholder="&#xF002; Buscar ..." style="font-family:Arial, FontAwesome"/>', {
            type: 'search',
  ...
  function PaginationPerPage(obj, settings) {
    ...
    this.create = function() {
      var $select = $('<select class="form-control" style="width:80px">', {
